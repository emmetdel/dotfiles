...
`sudo nixos-install --flake github:emmetdelaney/dotfiles#nixos`

### Darwin/Linux

`nix run nix-darwin -- switch --flake github:emmetdelaney/dotfiles`
...
`darwin-rebuild switch --flake ~/src/github.com/emmetdelaney/dotfiles`
...
```nix
{ config, pkgs, ... }: {
  home-manager.users.emmetdelaney = import ./home-manager/home.nix;
}
```
