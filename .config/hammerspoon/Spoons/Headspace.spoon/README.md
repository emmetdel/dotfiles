...
3. Download a [release](https://github.com/emmetdelaney/Headspace.spoon/releases) to `~/.hammerspoon/Spoons/Headspace.spoon`
...
The [older version](https://emmetdelaney.com/articles/2021/03/20/headspace-v1-0/) (integrated UI chooser and toggl tracker) is available for viewing here: [Version 1.1.4](https://github.com/emmetdelaney/Headspace.spoon/tree/1.1.4)
