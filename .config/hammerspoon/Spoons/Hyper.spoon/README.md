...
Just download [the latest release](https://github.com/emmetdelaney/Hyper.spoon/releases/latest/download/Hyper.spoon.zip), double click to unzip and double-click the resulting Hyper.spoon. It will be installed automatically by hammerspoon.
...
- [Original Blog Post](http://emmetdelaney.com/articles/2020/06/08/hammerspoon-a-better-better-hyper-key/)
